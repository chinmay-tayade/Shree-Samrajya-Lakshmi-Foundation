...
//preference
const mOneSignalID = 'YOUR ONE_SINGLE_ID';

//AdmobId
const adMobBannerId = "YOUR ADD_MOB_BANNER_ID";
const adMobInterstitialId = "YOUR ADD_MOB_INTERSTITIAL_ID";
const adMobBannerIdIos = "YOUR ADD_MOB_BANNER_ID_IOS";
const adMobInterstitialIdIos = "YOUR ADD_MOB_INTERSTITIAL_ID_IOS";

// Facebook
const FACEBOOK_KEY = "YOUR FACEBOOK_KEY";
const fbBannerId = "YOUR FB_BANNER_ID";
const fbBannerIdIos = "";
const fbInterstitialId = "YOUR FB_INTERSTITIAL_ID";
